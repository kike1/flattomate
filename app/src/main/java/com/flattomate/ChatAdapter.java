...
public class ChatAdapter extends ArrayAdapter<Announcement>{
    ...
    public ChatAdapter(Context context, int resource, ArrayList<Announcement> announcements){
                    ...
                    if(response.code() == 200) {
                        ...
                        if (response.body() != null){
                            ...
                            Picasso.with(_context)
                                    ...
                                    .resize(ad_adapter_image.getWidth(), ad_adapter_image.getHeight())
